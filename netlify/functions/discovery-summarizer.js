...
// ---- Gemini REST helper (no SDK; single fetch) ----
const GEMINI_MODEL = "gemini-2.5-pro";
const callGemini = async ({ system, user, maxOutputTokens = 8000 }) => {
...
<div style="font-family:-apple-system,system-ui,sans-serif;max-width:760px;color:#142640;">
  ...
  <p style="font-size:12px;color:#5a6a82;margin-top:32px;">Generated by BurnsBuilt Discovery Summarizer · Gemini 2.5 Pro · burnsbuilt.co</p>
</div>
`.trim(),
});
...
export const handler = async (event) => {
  ...
  // ---- Step 1: Generate the four docs with Gemini ----
  let output;
  try {
