 ...
 *   3. Claude Sonnet scores the lead, picks a tier, drafts a reply
...
<div style="font-family:-apple-system,system-ui,sans-serif;max-width:680px;color:#142640;">
  ...
  <p style="font-size:12px;color:#5a6a82;margin-top:32px;">Generated by BurnsBuilt Lead Qualifier · Claude Sonnet 4.5 · burnsbuilt.co</p>
</div>
`.trim(),
});
...
export const handler = async (event) => {
  ...
  try {
    ...
    analysis = {
      ...
      urgency: "medium",
      key_signals: [`Claude error: ${err.message?.slice(0, 80) || "unknown"}`],
